...
def add_entsog_capacity(IGGINL_df, entsog_dataset_wrapping,
    ...
    #convert gas capacity to hydrogen capacity
    entsog_dataset_wrapping['Capacity'] = entsog_dataset_wrapping['Capacity'].apply(convert_gas_to_hydrogen_capacity)
...
if __name__ == "__main__":
    ...
    if 'snakemake' not in globals():
        IGGINL_path = '../data/bundle/gas_network/INETNO_PipeSegments.csv'
        ...
        output_path = '../resources/gas_network_INETNO.csv'
    ...
    # add diameter data from EMAP
    IGGINL = add_EMAP_diameter(IGGINL,EMAP)
    # estimate capacity from diameter data
    IGGINL['capacity_nan'] = IGGINL['diameter_nan'].apply(recalculate_pipe_capacity)
    # add entsog capacity (already convert gas capacit to hydrogen capacity)
    IGGINL = add_entsog_capacity(IGGINL, entsog_dataset)
    # Predict the capacity of the pipeline that still lacks capacity
    # based on the capacity of other connected pipelines
